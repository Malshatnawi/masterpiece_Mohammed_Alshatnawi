...
<div class="container py-5">
    ...
    <div class="row mb-4">
        <div class="col-lg-6 mx-auto">
            <h1 class="display-4" style="font-weight:bolder">Checkout</h1>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-6 mx-auto">
            <div class="card ">
                <div class="card-header">
                    <div class="bg-white shadow-sm">
                        ...
                        <ul role="tablist" class="nav bg-light nav-pills rounded nav-fill mt-1 mb-3">
                            <li class="nav-item"> <a data-toggle="pill" href="#credit-card" class="nav-link active "> <i class="fa fa-credit-card mr-2"></i> Credit Card Payment</a> </li>
                    ...
                    <div class="tab-content">
                        <!-- credit card info-->
                         <div id="credit-card" class="tab-pane fade show active pt-3">
                            ...
                            <input type="hidden" name="amount" value="{{$The_Total_Price}}">
                                ...
                                <div id="LoadingMsg" class="alert alert-warning" style="display:none;" role="alert">
...
<!-- <div class="container">
    <div class="row">
        <div class="col-md-9">
            <p class="mb-4">
                Total Amount is <strong> {{$The_Total_Price}} JD</strong>
            </p>
...
<script>
    window.onload = function() {
            var stripe = Stripe('pk_test_51IIVeKDkFu2wCx3MQ2t8SpETYoTfACqn9fPicrLcFyMoRCD1ITD29sb6sIYkJ55arGkNox4Qs9dY70w8WB567coz00M0rqmxv1');
